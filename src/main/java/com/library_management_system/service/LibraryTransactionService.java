...
public class LibraryTransactionService {
    ...
    public LibraryTransactionService(LibraryTransactionRepository transactionRepository, BookRepository bookRepository, MemberRepository memberRepository, ModelMapper modelMapper) {
    ...
    public LibraryTransaction checkOutBook(Long memberId, Long bookId){
